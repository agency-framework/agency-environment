            ...
            gulp.task(taskName, function() {
                ...
                return gulp.src(pattern)
                    .on('data', function(file) {
                        ...
                        config.handlebars.partials.files.src.push('./node_modules/' + upath.basename(file.path) + '/src/tmpl/partials/**/*.hbs');
                        config.handlebars.layouts.files.src.push('./node_modules/' + upath.basename(file.path) + '/src/tmpl/partials/**/*.hbs');
                    });
            });
        });
    }
